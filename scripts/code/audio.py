...
class AudioVisualizer:
    ...
    def defineKeyboardGrid(self):
        nameGrid = [
            ...
            ["F10", "=", "]", "''", "", "Function"],
            ["F11", "Backspace", "BSlash", "Enter", "RightShift", "RightControl"], #F12 doesn't fit. It might be a good idea to put together with F11
    ...
    try:
        ...
        while(running):
            ...
            while True:
                ...
                sig = np.frombuffer(data, dtype='int8').reshape(-1, channelcount)
                ...
                freqs = []
                for freq in sig:
                    LRaverage = int(round((abs(freq[0]) + abs(freq[1])) / 2))
